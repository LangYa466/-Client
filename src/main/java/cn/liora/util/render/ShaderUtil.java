package cn.liora.util.render;

import cn.liora.util.MinecraftInstance;
import cn.liora.util.data.FileUtil;
...
public class ShaderUtil extends MinecraftInstance {
    ...
    public ShaderUtil(String fragmentShadersrc, boolean notUsed) {
        ...
        try {
            vertexShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("liora/shader/vertex.vsh")).getInputStream(), GL_VERTEX_SHADER);
        } catch (IOException e) {
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "liora/shader/vertex.vsh");
    }
