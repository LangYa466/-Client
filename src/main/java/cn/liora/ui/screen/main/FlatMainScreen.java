package cn.liora.ui.screen.main;

import cn.liora.ui.font.nano.NanoFontLoader;
import cn.liora.util.render.nano.NanoUtil;
import cn.liora.ui.screen.component.TextButton;
import cn.liora.util.data.resource.ResourceType;
import cn.liora.util.data.resource.ResourceUtil;
import cn.liora.util.render.RenderUtil;
import cn.liora.util.render.blur.BlurUtil;
import cn.liora.util.render.particle.ParticleManager;
import cn.liora.util.render.video.VideoPlayer;
...
public class FlatMainScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
       ...
       try {
           ...
           RenderUtil.drawImage(new ResourceLocation("liora/image/background2.png"), 0, 0, scaledWidth, scaledHeight);
        }
        ...
        NanoFontLoader.greyCliff.bold().drawGlowString("--- liora client, an experimental project", 35f, 50f, 18f, Color.GRAY);
        ...
        NanoFontLoader.greyCliff.bold().drawString("Love From ChengFeng, LangYa466", 30f, scaledHeight - 55f - 10f, 16f, Color.GRAY);
        NanoFontLoader.greyCliff.bold().drawString("TRACEABILITY", 30f, scaledHeight - 55f - 20f, 16f, Color.GRAY);
        NanoFontLoader.greyCliff.bold().drawString("2024-2025", 30f, scaledHeight - 55f - 30f, 16f, Color.GRAY);
        ...
        NanoFontLoader.greyCliff.bold().drawString("Hello#liora", width - 165f, 52f, 20f, textColor);
