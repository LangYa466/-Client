...
import cn.liora.ui.clickgui.gui.Icon;
...
import cn.liora.util.data.compare.StringComparator;
...
public class ModeComponent extends Component<String> {
    ...
    public ModeComponent(ModeValue value) {
        ...
        height = 13f;
        left = new Icon(new ResourceLocation("liora/icon/arrow-left.png"), 12f);
        right = new Icon(new ResourceLocation("liora/icon/arrow-right.png"), 12f);
