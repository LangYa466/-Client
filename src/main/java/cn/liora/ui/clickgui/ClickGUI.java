...
import cn.liora.ui.clickgui.panel.impl.CategoryPanel;
import cn.liora.ui.clickgui.panel.impl.ModulePanel;
import cn.liora.ui.font.awt.AWTFontLoader;
import cn.liora.ui.font.awt.AWTAWTFontRenderer;
import cn.liora.ui.font.awt.CenterType;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (CategoryType type : CategoryType.values()) {
            ...
            for (CategoryPanel panel : categoryPanelList) {
                ...
                RenderUtil.drawImage(new ResourceLocation("liora/icon/" + panel.category.name().toLowerCase(Locale.ROOT) + ".png"), categoryX, categoryY - 3f, 12, 12, ThemeColor.focusedColor);
        ...
        if (opacity != 0) {
            ...
            if (PostProcessing.bloom.getValue()) {
                ...
                RenderUtil.drawImage(new ResourceLocation("liora/icon/top.png"), roundX + 2.6f, roundY + 3.1f, 14f, 14f, ColorUtil.applyOpacity(Color.WHITE, opacity));
                BlurUtil.bloomEnd();
            }
        ...
        RenderUtil.drawImage(new ResourceLocation("liora/icon/search.png"), searchX + 3f, searchY + 3f, iconSize, iconSize, iconColorAnim.getOutput());
